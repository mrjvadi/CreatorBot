...
// یعنی این instanceِ رایگانِ vpn-bot الان به یک کمپینِ اجاره‌ی قفلِ فعال در
// ads-bot وصل است (رجوع memberclient.RunStatusLoop در main.go). وقتی خریدار
// این bot رایگان را در کانال خودش ادمین می‌کند، باید به ads-bot اطلاع دهیم
// تا قفل‌کردن برای آن تبلیغ شروع شود. همان الگوی uploader-bot/mychatmember.go.
package tgbot
