...
6️⃣ Send the token here ✅`,
	...
	KeyActionStopSent:     "⏹ Stop command sent",
	KeyActionStartSent:    "▶️ Start command sent",
	KeyActionRestartSent:  "🔄 Restart command sent",
	KeyActionDeleteSent:   "🗑 Delete command sent",
